...
<head>
  ...
  <title>Lautech Hotel Admin Panel</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg- dark" id="page-top" style="background-color: #25424C;">
  <!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-dark  fixed-top";  id="mainNav"
  style="background-color: #25424C; color: blue;">
    <a class="navbar-brand" href="adminPanel.php">ADMIN PANEL</a>
    <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarResponsive" style="background-color: #25424C;">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion" style="background-color: #25424C;">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="adminPanel.php">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text" >Home</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseExamplePages" style="background-color: #25424C;">
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti22">
            <li style="color: #f8f9fa;background-color: #25424C;">
              Admin Account
            </li> 
            <li>
