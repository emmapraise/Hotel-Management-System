...
<body>
        ...
        <div class="row">
         <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <input type="email" name = "email" class="form-control" id="email"  placeholder = "(e.g lautechhotel@domain.com)" required >
          </div>
        </div>
        <div class="col-md-6 col-sm-6">
          <div class="form-group">
        ...
        <div class="row">
         <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="address" placeholder = "(e.g Office Number, STREET, City, Country)" required>
          </div>
        </div>
        <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <div class="rq-checkout-form1 rq-checkout-country">
              <select required name="country" class="js-example-placeholder-single form-control rq-checkout-form-select">
                <option>&nbsp;</option>
                <option value="Australia" selected="selected">Nigeria</option>
  ...
  <!--   <h1 class="rq-checkout-form-title">additional information</h1>
    ...
    <button class="btn btn-lg btn-primary" name="submit" type="submit" style="height: 50px;">Register</button>
  </form>
</div>
</div>
</div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          ...
          <address>
            <ul>
              <li class="rq-hotel-address"><i class="fa fa-map-marker"></i>Along Ilorin Express Way,
                <br> Aroje area, Ogbomoso L.G.A</li>
              <li class="rq-phone"><i class="fa fa-phone"></i>(234) 810593 3386</li>
              <li class="rq-email"><i class="fa fa-envelope-o"></i>oyebodejoe@gmail.com</li>
            </ul>
          </address>
        </div>
