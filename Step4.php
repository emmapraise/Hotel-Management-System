                ...
                <div class = "table-responsive">
                  <table class = "table table-condensed">
                      ...
                      if(count($_SESSION['reservation']['services']) != 0){
                        ...
                        foreach($_SESSION['reservation']['services'] as $service => $service_name){
                          ...
                          <tr>
                            ...
                            <td class ='highrow text-right'>  &#8358; <?=number_format($getaddon['Addon_rate'],2)?></td>
                          </tr>
                          <?php 
                        }
                      } 
                    ...
                    <tr>
                      ...
                      <td class=" text-right" bgcolor="#EBEDF2"> &#8358; 
                        <?= number_format($total,2) . " * 15% =  &#8358; " . number_format($downpayment,2) ?>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class=" highrow text-right"> &#8358; 
                        <?= number_format($_SESSION['reservation']['balance'],2) ?>
                      </td>
                    </tr>
                  </tbody>
                </table>
