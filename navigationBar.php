	...
	<header>
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <!-- Logo -->
          <a class="navbar-brand" href="index.php"><img class="logo" src="homelogo.png" alt="Lautechhotel" style="margin-top: 10px; margin-left: 30px;" ></a>
        </div>
        <!-- Navbar Toggle End -->
