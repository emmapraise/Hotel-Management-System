        ...
        <div class="row">
         <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <input type="email" name = "email" class="form-control" id="email"  placeholder = "(e.g Lautech@domain.com)" required >
          </div>
        </div>
        <div class="col-md-6 col-sm-6">
          <div class="form-group">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          ...
          <address>
            <ul>
              <li class="rq-hotel-address"><i class="fa fa-map-marker"></i>57 Epifanio de los Santos Ave,<br>Ogbomoso, 1233 Metro Manila</li>
