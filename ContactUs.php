  ...
  <div class = "container">
    <div class = "row">
      <div class = "col-lg-12">
        ...
        <p>
           Even if there is something you have always wanted to experience and can't find it on Lautech Hotel, let us know and we promise we'll do our best to find it for you and send you there.
         </p>
      </div>
    </div>
  </div>
               ...
               <div class="rq-address-wrapper rq-message-address-2">
                ...
                <ul>
                  <li>
                    ...
                    <a href="#">Along Ilorin Express Way,<br> <span> Aroje area, Ogbomoso </span> </a>
                  </li>
                  <li>
                    <i class="fa fa-phone" aria-hidden="true"></i>
                    <a href="#">(234) 810890 9729</a>
                  </li>
                  <li>
                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                    <a href="#">info@lautechhotel.com</a>
                  </li>
                </ul>
               </div>
             </div>
