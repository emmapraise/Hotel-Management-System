                    ...
                    <tbody> 
                      <tr>
                        ...
                        <td class="text-right" bgcolor="#EBEDF2">&#8358; 
                          <?=number_format($room['room_rate'] * $reservation['room_number'],2)?> 
                        </td>
                      </tr>
                      <tr>
                        <td class="text-left" bgcolor="#EBEDF2">
                      ...
                      <tr>
                        ...
                        <td class="highrow text-right">  &#8358; 
                         <?= number_format(($billing['total'])*0.88,2)?>
                       </td>
                     </tr>
                     <tr>
                      <td class="text-left" bgcolor="#EBEDF2">
                      ...
                      <td class="text-right" bgcolor="#EBEDF2">  &#8358; 
                        <?= number_format($billing['total']* 0.12,2) ?>
                      </td>
                    </tr>
                    <tr>
                      <td class="text-left" bgcolor="#EBEDF2">
                      ...
                      <td class=" text-right" bgcolor="#EBEDF2">  &#8358; 
                        <?= number_format($billing['total'], 2) . " * 15% =   &#8358; ". number_format($billing['total'] * 0.15, 2)?>
                      </td>
                    </tr>
                    <tr>
                      <td class="text-left">
